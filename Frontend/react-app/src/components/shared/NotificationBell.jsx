...
export default function NotificationBell() {
  ...
  return (
    <div className="nb-wrap" ref={wrapRef}>
      <button className="nb-btn" onClick={handleToggle} aria-label="Notifications">
        <span className="nb-icon-clip">
          <img src={notificationicon} alt="Notifications" className="nb-icon" />
        </span>
