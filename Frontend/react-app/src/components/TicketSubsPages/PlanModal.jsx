      ...
      <div className="bg-white p-10 rounded-2xl w-[440px] shadow-2xl">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <input type="number" value={formData.activeJobs}
          ...
          <div>
            ...
            <input type="number" value={formData.interviewers}
          ...
          <div>
            ...
            <input type="number" value={formData.aiCvLimit}
          ...
          <div>
            ...
            <input type="number" value={formData.aiQuestionLimit}
              disabled={formData.isUnlimited}
        ...
        <div className="flex justify-end gap-4 mt-8">
          ...
          <button onClick={handleSubmit} className="px-4 py-2 bg-[#24698B] text-white rounded-lg">Save</button>
        </div>
      </div>
    </div>
  );
