...
export default function ChatBot() {
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      ...
      const { reply, remaining: rem, warning: warn, limitReached: limited } = res.data;
      ...
      // Handle 429 limit response from backend
  ...
  const usagePercent = Math.round(((DAILY_LIMIT - remaining) / DAILY_LIMIT) * 100);
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <span style={styles.ragBadge}>RAG</span>
        </div>
        {/* Daily usage indicator */}
        <div style={styles.usageWrapper}>
          <span style={styles.usageText}>{remaining} / {DAILY_LIMIT} remaining</span>
          <div style={styles.usageTrack}>
            <div
              style={{
                ...styles.usageFill,
                width: `${usagePercent}%`,
                background: usagePercent >= 90 ? "#dc2626" : usagePercent >= 70 ? "#d97706" : "#1a7f64",
              }}
            />
          </div>
        </div>
...
function MessageRow({ msg }) {
  ...
  return (
    <div style={{ ...styles.msgRow, justifyContent: isUser ? "flex-end" : "flex-start" }}>
      {!isUser && <Avatar label="AI" color="#1a7f64" bg="#e0f5ee" />}
      <div style={{ maxWidth: "72%" }}>
        <div
          style={{
            ...styles.bubble,
            background: isUser ? "#1a7f64" : "#f5f7f9",
      ...
      {isUser && <Avatar label="K" color="#1a7f64" bg="#d1fae5" />}
    </div>
  );
}
...
function TypingIndicator() {
  return (
    <div style={{ display: "flex", gap: 10, alignItems: "flex-start", padding: "4px 0" }}>
      <Avatar label="AI" color="#1a7f64" bg="#e0f5ee" />
