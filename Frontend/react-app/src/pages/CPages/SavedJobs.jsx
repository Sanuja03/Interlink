                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 shrink-0">
                                        ...
                                        <button
                                            ...
                                            style={{
                                                background: appliedJobIds.includes(job.jobId) ? '#718096' : 'linear-gradient(135deg, #0C3E56, #1a6a82)',
                                                outline: 'none',
                                                border: 'none',
                                                boxShadow: appliedJobIds.includes(job.jobId) ? 'none' : '0 2px 8px rgba(0,0,0,0.18)',
                                                cursor: appliedJobIds.includes(job.jobId) ? 'not-allowed' : 'pointer'
                                            }}
                                        >
                                            {appliedJobIds.includes(job.jobId) ? 'Already Applied' : 'Apply Now'}
                                        </button>
                                    </div>
